...
function getHome(callback) {
    callback({
        type: "success",
        value: '{"Featured":[{"title":"Test","url":"61323","posterUrl":"https://via.placeholder.com/300x450"}]}'
    });
}
...
function search(query, callback) {
    callback({
        type: "success",
        value: '[{"title":"' + query + '","url":"61323","posterUrl":"https://via.placeholder.com/300x450"}]'
    });
}
